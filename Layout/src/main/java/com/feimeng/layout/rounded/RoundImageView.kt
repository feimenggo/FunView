package com.feimeng.layout.rounded
...
class RoundImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        val a = getContext().obtainStyledAttributes(attrs, R.styleable.RoundImageView, 0, 0)
        val cornerRadius = a.getDimensionPixelSize(R.styleable.RoundImageView_cornerRadius, 0)
        val corners = a.getInt(R.styleable.RoundImageView_cornerMode, ALL_ROUNDED_CORNERS_VALUE)
        reverseMask = a.getBoolean(R.styleable.RoundImageView_reverseMask, reverseMask)
        a.recycle()
        init()
        setCornerRadiusInternal(cornerRadius)
        setRoundedCornersInternal(corners)
        fixPadding()
        setupPath()
    }

    constructor(context: Context, attrs: AttributeSet, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        val a = getContext().obtainStyledAttributes(attrs, R.styleable.RoundImageView, defStyleAttr, 0)
        val cornerRadius = a.getDimensionPixelSize(R.styleable.RoundImageView_cornerRadius, 0)
        val roundedCorners = a.getInt(R.styleable.RoundImageView_cornerMode, ALL_ROUNDED_CORNERS_VALUE)
        reverseMask = a.getBoolean(R.styleable.RoundImageView_reverseMask, reverseMask)
        a.recycle()
        init()
        setCornerRadiusInternal(cornerRadius)
