...
//        setWidth(LayoutParams.MATCH_PARENT);
    ...
    private void handleOnGlobalLayout() {
        ...
        Point validSize = new Point();
        activity.getWindowManager().getDefaultDisplay().getSize(validSize);
        Rect rect = new Rect();
        popupView.getWindowVisibleDisplayFrame(rect);
        Log.d("nodawang", "screenSize:" + screenSize + " validSize:" + validSize + " keyboardSize:" + rect);
