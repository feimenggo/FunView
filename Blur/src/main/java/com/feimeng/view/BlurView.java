...
public class BlurView extends View {
    ...
    public BlurView(Context context, AttributeSet attrs) {
        ...
        setDownsampleFactor(a.getInt(R.styleable.BlurView_downsampleFactor, defaultDownsampleFactor));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBlurredView != null) {
            if (prepare()) {
                ...
                if (mVagueHeight != -1) {
                    blur(dp2px(getContext(), mVagueHeight));
                } else
                    blur(mVagueHeight);
